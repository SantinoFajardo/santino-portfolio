...
const Nav: React.FC = (): React.ReactElement => {
  return (
    <nav className="w-full bg-opacity-75 backdrop-blur-md shadow-md bg-[#111111] fixed h-[5vh] py-3 px-5 md:px-20 z-20">
      <div className="w-full hidden sm:flex items-center justify-between">
        <div className="flex-row gap-x-2 justify-center items-center hidden md:flex">
          ...
          />
          <h1 className="text-white text-sm font-semibold">Santino Fajardo</h1>
        </div>
        <div className="text-white flex flex-row gap-x-4 text-sm">
          <Link
            to="home"
            duration={500}
            smooth={true}
            className="hover:cursor-pointer hover:border-b border-white">
            Home
          </Link>
          <Link
            to="experience"
          ...
          <a className="hover:cursor-pointer hover:border-b border-white">
            Blog
          </a>
          <a className="hover:cursor-pointer hover:border-b border-white">
            Courses
